import torch
from models.renoise_audio.spectralgate.base import SpectralGate
from models.renoise_audio.torchgate import TorchGate as TG
import numpy as np


class StreamedTorchGate(SpectralGate):
    '''
    Run interface with renoise_audio.
    '''
